...
data class ValidatableField(
    ...
    val minLength: Int = 0,
    val maxLength: Int = MAX_FIELD_LENGTH_LARGE,
    ...
    fun validate(): ValidationResult {
        ...
        return when {
            ...
            isMinLengthError -> ValidationResult(false, stringResource(R.string.error_min_length, minLength))
            maxCharError -> ValidationResult(false, stringResource(R.string.error_max_length, maxLength))
            allowGapsError -> ValidationResult(false, stringResource(R.string.error_no_gaps))
            specialCharsError -> ValidationResult(false, stringResource(R.string.error_no_special_chars))
            capitalLettersError -> ValidationResult(false, stringResource(R.string.error_no_capital_letters))
            onlyEnglishLettersError -> ValidationResult(false, stringResource(R.string.error_only_english_letters))
